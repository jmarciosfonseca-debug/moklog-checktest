...
export default function DiagnosticoSituacional({ auth, db, dark, onToggleTheme, onBack }) {
  ...
  const mark=(itemId,status)=>setRespostas(current=>({...current,[itemId]:{status,updatedAt:Date.now()}}));
