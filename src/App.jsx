...
const PROJECTS = {
  ...
  P311B: {id:"P311B",name:"Mega CL Itaja\u00ed",short:"Itaja\u00ed",categories:[{id:"cftv",label:"01 - CFTV",type:"count",total:114},{id:"perimeter",label:"02 - Alarme Perimetral",type:"items",itemLabels:["Zona 01","Zona 02","Zona 03","Zona 04","Zona 05","Zona 06"]},{id:"botoeiras",label:"03 - Botoeiras do Dilacerador",type:"items",itemLabels:["Botoeira 01","Botoeira 02","Botoeira 03"]},{id:"panic",label:"04 - Bot\u00f5es de P\u00e2nico",type:"items",itemLabels:["CCO Fixo","Ronda M\u00f3vel","L\u00edder M\u00f3vel"]},{id:"portas_cco",label:"05 - CCO / Controle de Acesso",type:"items",itemLabels:["Porta 01 Externa \u2013 Local","Porta 01 Externa \u2013 Remota","Porta 02 Interna \u2013 Local","Porta 02 Interna \u2013 Remota"]},{id:"keyaccess",label:"06 - Sistema KeyAccess",type:"items",itemLabels:["Catraca 01","Catraca 02","Catraca 03"]},{id:"totens_auto",label:"07 - Totem de Autoatendimento",type:"items",itemLabels:["Externo 01","Externo 02","Interno 01"]},{id:"totens_cancela",label:"08 - Totens nas Cancelas",type:"items",itemLabels:["Totem Cancela 01","Totem Cancela 02","Totem Cancela 03","Totem Cancela 04","Totem Cancela 05","Totem Cancela 06"]},{id:"qr_code",label:"09 - Leitores QR Code",type:"items",itemLabels:["Cancela 01 Sup","Cancela 01 Inf","Cancela 02 Sup","Cancela 02 Inf","Cancela 04 Sup","Cancela 04 Inf","Sa\u00edda Cancela 02 Sup","Sa\u00edda Cancela 02 Inf","Sa\u00edda Cancela 03 Sup","Sa\u00edda Cancela 03 Inf","Sa\u00edda Cancela 04 Sup","Sa\u00edda Cancela 04 Inf"]},{id:"computadores",label:"10 - Computadores / CCO",type:"items",itemLabels:["Computador Principal","Computador Secund\u00e1rio","Internet"]},{id:"portoes",label:"11 - Port\u00f5es",type:"items",itemLabels:["Port\u00e3o 01","Port\u00e3o 02","Port\u00e3o 03","Port\u00e3o 04"]},{id:"dilaceradores",label:"12 - Dilaceradores",type:"items",itemLabels:["Cancela 01","Cancela 02","Cancela 03","Cancela 04"]},{id:"ac",label:"13 - Ar-Condicionado",type:"items",itemLabels:["CCO","Sala T\u00e9cnica"]},{id:"materiais",label:"14 - Materiais Operacionais",type:"items",itemLabels:["Smartphone (x3)","Lanterna (x2)","Armamento (x2)","Muni\u00e7\u00e3o (x36)","R\u00e1dio HT (x3)","Bodycam (x2)","Moto de Ronda","P\u00e2nico ZTRAX (x2)"]},{id:"sdai",label:"15 - SDAI (Inc\u00eandio)",type:"items",itemLabels:["Central Portaria","Central Casa de Bombas","Central Sala T\u00e9cnica"]},{id:"manutencao",label:"16 - Visita de Manuten\u00e7\u00e3o",type:"maintenance"},{id:"infra",label:"17 - Infraestrutura / Obs.",type:"notes"}]},
    ...
    <div style={S.page}>
      <div style={S.formWrap}>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:10}}>
          <button onClick={()=>generatePDF(project,state,meta,photos)} style={{...S.primaryBtn,flex:1,background:"linear-gradient(135deg,#7c3aed,#6d28d9)",fontSize:13}}>📄 Exportar PDF</button>
