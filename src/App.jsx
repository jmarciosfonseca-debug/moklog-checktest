...
// Projetos com módulo Perimetral COMPLETO (mapa de zonas + status + continuidade da ronda).
// Substitui a Ronda Diária nesses sites. Adicione o id aqui quando o parque ganhar mapa próprio.
const PERIM_FULL = ["P505","P602"];
