...
const PROJECTS = {
  P601: {
    ...
    categories:[
      ...
      {id:"cancelas",label:"06 - CANCELAS AS (ALTA SEGURAN\u00c7A)",type:"items",itemLabels:["Acesso 01","Acesso 02","Acesso 03","Acesso 04","Acesso 05"]},
      ...
      {id:"monitores",label:"13 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01"]},
      {id:"monitores_cftv",label:"14 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02","Monitor 03"]},
      {id:"monitores_portaria",label:"15 - MONITOR PORTARIA",type:"notes"},
  ...
  P602: {id:"P602",name:"Golgi Mau\u00e1",short:"Mau\u00e1",categories:[
      ...
      {id:"cco_equip",label:"04 - CCO (EQUIPAMENTOS)",type:"items",itemLabels:["Ar-Condicionado","Mesa Gatbox","Joystick","CPU 01","CPU 02","CPU 03"]},
      ...
      {id:"monitores",label:"08 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01"]},
      {id:"monitores_cftv",label:"09 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02"]},
      {id:"monitores_portaria",label:"10 - MONITOR PORTARIA",type:"notes"},
  ...
  P604: {id:"P604",name:"Golgi Jundia\u00ed",short:"Jundia\u00ed",categories:[
      ...
      {id:"monitores",label:"14 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01"]},
      {id:"monitores_cftv",label:"15 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02","Monitor 03","Monitor 04"]},
      {id:"monitores_portaria",label:"16 - MONITOR PORTARIA",type:"notes"},
  ...
  P605: {id:"P605",name:"Golgi Dutra",short:"Dutra",categories:[
      ...
      {id:"monitores",label:"15 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01"]},
      {id:"monitores_cftv",label:"16 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02","Monitor 03","Monitor 04","Monitor 05"]},
      {id:"monitores_portaria",label:"17 - MONITOR PORTARIA",type:"notes"},
  ...
  P606: {id:"P606",name:"Golgi Duque de Caxias",short:"Duque",categories:[
      ...
      {id:"monitores",label:"12 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01","Monitor 02"]},
      {id:"monitores_cftv",label:"13 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02"]},
      {id:"monitores_portaria",label:"14 - MONITOR PORTARIA",type:"notes"},
  ...
  P607: {id:"P607",name:"Golgi Bras\u00edlia",short:"Bras\u00edlia",categories:[
      ...
      {id:"monitores",label:"10 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01"]},
      {id:"monitores_cftv",label:"11 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02","Monitor 03"]},
      {id:"monitor_ka",label:"12 - MONITOR KEYACCESS",type:"items",itemLabels:["Monitor 01"]},
      {id:"monitores_portaria",label:"13 - MONITOR PORTARIA",type:"notes"},
  ...
  P311A: {id:"P311A",name:"Mega CL Curitiba",short:"Curitiba",categories:[
      ...
      {id:"monitores",label:"14 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01","Monitor 02","Monitor 03"]},
      {id:"monitores_cftv",label:"15 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02"]},
  ...
  P311B: {id:"P311B",name:"Mega CL Itaja\u00ed",short:"Itaja\u00ed",categories:[
      ...
      {id:"monitores",label:"11 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01","Monitor 02","Monitor 03","Monitor 04"]},
      {id:"monitores_cftv",label:"12 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02"]},
  ...
  P505: {id:"P505",name:"Klog Guarulhos",short:"Guarulhos",categories:[
      ...
      {id:"monitores",label:"16 - MONITOR CCO CDA (CONTROLE DE ACESSO)",type:"items",itemLabels:["Monitor 01"]},
      {id:"monitores_cftv",label:"17 - MONITOR CCO CFTV",type:"items",itemLabels:["Monitor 01","Monitor 02","Monitor 03","Monitor 04","Monitor 05"]},
      {id:"monitores_portaria",label:"18 - MONITOR PORTARIA",type:"notes"},
