      ...
      <div style={S.page}>
        <div style={S.formWrap}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:10,marginTop:10}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
              <button onClick={()=>{setEquipeProject({id:"P260A",name:"Jatinox Unidade A"});setShowEquipe(true);}} style={{background:"linear-gradient(165deg,#0ea5e911,#0ea5e906)",border:"1.5px solid #0ea5e944",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>👥</span><span style={{fontSize:14,fontWeight:700,color:"#0ea5e9",letterSpacing:.3}}>Equipe</span></button>
              <button onClick={()=>{setAcessoCCOProject({id:"P260A",name:"Jatinox Unidade A"});setShowAcessoCCO(true);}} style={{background:"linear-gradient(165deg,#22c55e11,#22c55e06)",border:"1.5px solid #22c55e44",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>🚪</span><span style={{fontSize:14,fontWeight:700,color:"#22c55e",letterSpacing:.3}}>CCO</span></button>
            </div>
              ...
              {checkAuth(project.id)?(
                <>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
                    ...
                    <button onClick={()=>{setEquipamentosProject(project);setShowEquipamentos(true);}} style={{background:"linear-gradient(165deg,#f59e0b11,#f59e0b06)",border:"1.5px solid #f59e0b44",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>🛡️</span><span style={{fontSize:14,fontWeight:700,color:"#f59e0b",letterSpacing:.3}}>Equipamentos</span></button>
                    <button onClick={()=>{setEmpresaInfoProject(project);setShowEmpresaInfo(true);}} style={{background:"linear-gradient(165deg,#a855f711,#a855f706)",border:"1.5px solid #a855f744",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>🏢</span><span style={{fontSize:14,fontWeight:700,color:"#a855f7",letterSpacing:.3}}>Empresas</span></button>

                    {PERIMETRAL_ELIGIBLE.includes(project.id)&&<button onClick={()=>{setPerimetralProject(project);setShowPerimetral(true);}} style={{background:"linear-gradient(165deg,#a855f711,#a855f706)",border:"1.5px solid #a855f744",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>🔒</span><span style={{fontSize:14,fontWeight:700,color:"#a855f7",letterSpacing:.3}}>Teste Perimetral</span></button>}
                    {BOLSAO_ELIGIBLE.includes(project.id)&&<button onClick={()=>{setBolsaoProject(project);setShowBolsao(true);}} style={{background:"linear-gradient(165deg,#f59e0b11,#f59e0b06)",border:"1.5px solid #f59e0b44",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>🚧</span><span style={{fontSize:14,fontWeight:700,color:"#f59e0b",letterSpacing:.3}}>Fiscalização de Bolsão</span></button>}
                    {project.id==="P601"&&<button onClick={()=>setShowRondaVSPP(true)} style={{background:"linear-gradient(165deg,#0f6e5611,#0f6e5606)",border:"1.5px solid #0f6e5644",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>🚗</span><span style={{fontSize:14,fontWeight:700,color:"#0f6e56",letterSpacing:.3}}>Ronda VSPP</span></button>}
                    <button onClick={()=>{setInquilinosProject(project);setShowInquilinos(true);}} style={{background:"linear-gradient(165deg,#06b6d411,#06b6d406)",border:"1.5px solid #06b6d444",borderRadius:14,padding:"14px 16px",cursor:"pointer",width:"100%",display:"flex",alignItems:"center",gap:12,textAlign:"left",boxShadow:"0 4px 14px rgba(0,0,0,.3), inset 0 1px 0 rgba(255,255,255,.04)"}}><span style={{fontSize:24,flexShrink:0}}>🏗️</span><span style={{fontSize:14,fontWeight:700,color:"#06b6d4",letterSpacing:.3}}>Inquilinos / Galpões</span></button>
                  </div>
                </>
              ):(
                <>
